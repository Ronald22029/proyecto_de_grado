                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            if($_SERVER["REQUEST_METHOD"]=="POST")
                            {
                                ...
                                $sql="delete from usuarios where nombres='$usuario';";
                                ...
                                {
                                    echo "<div class='alert alert-danger' role='alert'>
                                    <strong>No se pudo Eliminar el usuario</strong>
                                    </div>";
                                }
                            ...
                            <input class="form-control form-control-user" type="text" value="<?php echo $usuario; ?>" readonly="">
                            </div>
                        </div>
                </div>
            </div>
            <footer class="bg-white sticky-foo ter">
